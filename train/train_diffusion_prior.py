...
def initialize_training(config_file, accelerator):
    ...
    training_set = myDataset('data/split_2/train.csv')

    train_loader = DataLoader(training_set, batch_size=16)

    test_set = myDataset('data/split_2/test.csv')

    test_loader = DataLoader(test_set, batch_size=16)

    val_set = myDataset('data/split_2/val.csv')

    eval_loader = DataLoader(val_set, batch_size=16)
