...
def mrr(seq1=None, labels1=None, seq2=None, labels2=None, emb1=None, emb2=None, n=1000, embedding='spectrum', ignore_parents=False, ignore_childs=False, godag=PATH+'/../data/godag.obo', return_ranks=False, terms=terms, warning=True, **kwargs):
    '''
