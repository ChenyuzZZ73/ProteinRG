...
def get_parser(parser=None):
    ...
    parser.add_argument("--dims", type=int, nargs="*", default=[640], required=False)
    parser.add_argument(
        "--smiles_embedding",
        type=str,
        default="data/Pretrained MoLFormer/checkpoints/N-Step-Checkpoint_3_30000.ckpt",
    )
    ...
    parser.add_argument("--checkpoints_folder", type=str, default="./result/", required=True)
